...
public class SelectionBuilder {
    ...
    public SelectionBuilder reset() {
		...
		if (mSelectionArguments != null) {
			mSelectionArguments.clear();
		}
        return this;
    }
    ...
    private void ensureSelectionArgs() {
    	if (mSelectionArguments == null) {
    		mSelectionArguments = new ArrayList<String>();
    	}
    }
    ...
    public String[] getSelectionArgs() {
    	if (mSelectionArguments != null) {
            return mSelectionArguments.toArray(new String[mSelectionArguments.size()]);
    	} else {
    		return null;
    	}
    }
